...
CREATE TABLE "public"."products" ("id" serial NOT NULL, "product_name" character varying(255) NULL, PRIMARY KEY ("id"), CONSTRAINT "products_product_name_key" UNIQUE ("product_name"), CONSTRAINT "products_product_name_check" CHECK (char_length((product_name)::text) > 0));
...
-- Create "orders" table
CREATE TABLE "public"."orders" ("id" serial NOT NULL, "user_id" integer NOT NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP, "total_amount" bigint NOT NULL, "currency" character varying(12) NOT NULL DEFAULT 'USD', "status" character varying(12) NOT NULL DEFAULT 'PENDING', PRIMARY KEY ("id"), CONSTRAINT "orders_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "orders_currency_check" CHECK ((currency)::text = ANY ((ARRAY['USD'::character varying, 'INR'::character varying, 'BTC'::character varying, 'ETH'::character varying, 'SOL'::character varying])::text[])), CONSTRAINT "orders_status_check" CHECK ((status)::text = ANY ((ARRAY['PENDING'::character varying, 'PROCESSING'::character varying, 'SHIPPED'::character varying, 'CANCELED'::character varying, 'REFUNDED'::character varying])::text[])));
-- Create index "idx_orders_user_id" to table: "orders"
CREATE INDEX "idx_orders_user_id" ON "public"."orders" ("user_id");
-- Create "order_items" table
CREATE TABLE "public"."order_items" ("id" serial NOT NULL, "order_id" integer NOT NULL, "product_id" integer NOT NULL, "seller_id" integer NOT NULL, "quantity" integer NOT NULL, "price" bigint NOT NULL, "currency" character varying(12) NOT NULL DEFAULT 'USD', "status" character varying(12) NOT NULL DEFAULT 'PENDING', PRIMARY KEY ("id"), CONSTRAINT "order_items_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."orders" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "order_items_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "order_items_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "public"."seller" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "order_items_currency_check" CHECK ((currency)::text = ANY ((ARRAY['USD'::character varying, 'INR'::character varying, 'BTC'::character varying, 'ETH'::character varying, 'SOL'::character varying])::text[])), CONSTRAINT "order_items_status_check" CHECK ((status)::text = ANY ((ARRAY['PENDING'::character varying, 'PROCESSING'::character varying, 'SHIPPED'::character varying, 'CANCELED'::character varying, 'REFUNDED'::character varying])::text[])));

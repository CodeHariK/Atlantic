...
CREATE TABLE "public"."inventory" ("id" serial NOT NULL, "product_id" integer NOT NULL, "seller_id" integer NOT NULL, "quantity" integer NOT NULL, "amount.units" bigint NOT NULL, "amount.nanos" integer NOT NULL, "amount.currency" character varying(12) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "inventory_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "inventory_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "public"."seller" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);

					...
					item(hit: any, { html, components }: any) {
                        ...
                        ${hit.gen?.map(
								(gen: string) =>
                                 ...
                                 onclick=${() => {
											search.helper
												?.toggleFacetRefinement("gen", gen)
												.search();
										}}
                                 class="text-sm bg-gray-100 dark:bg-gray-700 p-1 m-1 rounded-lg"
                              >
                                 ${gen}
                              </button>`,
							)}
                     ...
                     >
                        ...
                        >
                           ...
                           <p class="dark:text-blue-300 text-clip line-clamp-4">
                              ${components.Snippet({
								attribute: "info",

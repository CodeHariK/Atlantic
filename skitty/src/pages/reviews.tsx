         ...
         <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="flex items-center gap-2">
               ...
               <div class="mt-2 flex items-center gap-2 sm:mt-0">
                  <RatingsBar />
                  <p class="text-sm font-medium leading-none text-gray-500 dark:text-gray-400">({props.rating.toFixed(2)})</p>
            ...
            <div class="my-6 gap-8 sm:flex sm:items-start md:my-8">
               <div class="shrink-0 space-y-4">
                  <p class="text-2xl font-semibold leading-none text-gray-900 dark:text-white">{props.rating.toFixed(2)} out of 5</p>
            ...
            <div class="mt-6 divide-y divide-gray-200 dark:divide-gray-700">
               ...
               <Review
                  name="Rachel"
                  comment="It’s fancy, amazing keyboard, matching accessories. Super fast, batteries last more than usual, everything runs perfect in this computer. Highly recommend!"
                  imgs={["https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-photo-1.jpg", "https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-photo-2.jpg"]} />

               <Review
                  name="Julie"
                  comment="I replaced my 11 year old iMac with the new M1 Apple. I wanted to remain with Apple as my old one is still working perfectly and all Apple products are so reliable. Setting up was simple and fast and transferring everything from my previous iMac worked perfectly."
                  imgs={[]} />

               <Review
                  name="Molly"
                  comment="I have used earlier Mac computers in my university work for a number of years and found them easy to use.The iMac 2021 is no exception. It works straight out of the box giving superb definition from the HD screen. Basic tools such as a browser (Safari) and a mail client are included in the system. Microsoft Office apps can be downloaded from the App Store though they may only work in read-only mode unless you take out a subscription. The instruction manual that comes with it is the size of a piece of toilet paper but the proper user guide is on-line."
                  imgs={[]} />

               <Review
                  name="Rossana"
                  comment="My old IMAC was from 2013. This replacement was well needed. Very fast, and the colour matches my office set up perfectly. The display is out of this world and I’m very happy with this purchase."
                  imgs={[]} />
...
function Review(props: { name: string, comment: string, imgs: string[] }) {
   return <div class="gap-3 py-6 sm:flex sm:items-start">
      <div class="shrink-0 space-y-2 sm:w-48 md:w-72">
         <RatingsBar />

         <div class="space-y-0.5">
            <p class="text-base font-semibold text-gray-900 dark:text-white">{props.name}</p>
      ...
      <div class="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
         <p class="text-base font-normal text-gray-500 dark:text-gray-400">{props.comment}</p>

         <div class="flex gap-2">
            {props.imgs.map((m) => (
               <img class="h-32 w-20 rounded-lg object-cover" src={m} alt="" />
            ))}
         </div>

...
/**
 * @generated from message order.v1.Cart
 */
export class Cart extends Message<Cart> {
  ...
  static readonly typeName = "order.v1.Cart";
...
/**
 * @generated from message order.v1.CartItem
 */
export class CartItem extends Message<CartItem> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "order.v1.CartItem";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message order.v1.ProductComment
 */
export class ProductComment extends Message<ProductComment> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "order.v1.ProductComment";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },

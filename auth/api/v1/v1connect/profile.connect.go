...
var (
	profileServiceServiceDescriptor             = v1.File_v1_profile_proto.Services().ByName("ProfileService")
...
// UpdateProfile calls profile.v1.ProfileService.UpdateProfile.
...
func (UnimplementedProfileServiceHandler) UpdateProfile(context.Context, *connect.Request[v1.UpdateProfileRequest]) (*connect.Response[v1.UpdateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("profile.v1.ProfileService.UpdateProfile is not implemented"))
}
